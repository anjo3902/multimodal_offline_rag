...
class MultiFallbackGenerator:
    ...
    def _try_load_ollama(self):
        ...
        try:
            ...
            # Optimized for fast, accurate answers with proper citations
            llm = OllamaLLM(
                model=model_name,
                temperature=0.3,  # Lower for more focused, factual answers
                num_predict=1024,  # Reduced for faster generation while still complete
                ...
                num_thread=4,
                timeout=120  # 2 minutes - faster timeout
            )
